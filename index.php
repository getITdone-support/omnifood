        ...
        <section class="section-features">
            ...
            <div class="row">
                <div class="col span-1-of-4 box">
                    <i class="icon ion-md-planet icon-big"></i>
                ...
                <div class="col span-1-of-4 box">
                    <i class="icon ion-md-clock icon-big"></i>
        ...
        <section class="section-steps">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    <img src="../resources/img/app-iPhone.png" alt="Omifood app of iPhone" class="app-screen">
                </div>
        ...
        <section class="section-cities">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-4 box">
                    ...
                    <div class="citi-feature">
                        <i class="icon ion-md-heart icon-small"></i>
                        60+ top chefs
